...
# =============================================================================
    ...
    **Interpretation:** Green indicates lower values (less penetration / less competition), 
    ...
    # Demand Score Chart - FIX APPLIED: Increased bottom margin to 180 and moved legend down to y=-0.5
    ...
    fig_demand.update_layout(
        ...
        annotations=[
            dict(
                ...
                x=0.5, y=-0.5, # FIX: Moved further down
                showarrow=False,
                font=dict(size=11),
                align="center"
            )
        ],
        margin=dict(b=180) # FIX: Increased to 180 to prevent overlap
    )
...
# =============================================================================
    ...
    **Critical Execution Drivers:**
    ...
    # Scenario Chart - FIX APPLIED: Moved Legend to bottom to prevent blocking chart
    ...
    # Target line - FIX APPLIED: Moved annotation to the far right
    ...
    fig_scenario.update_layout(
        ...
        # FIX: Moved legend to bottom horizontally
        legend=dict(
            orientation="h",
            yanchor="top",
            y=-0.2,
        ...
        margin=dict(b=100) # Increased bottom margin for legend
    )
...
# =============================================================================
    ...
    **Five Guys, BurgerFi, Smashburger, and Chipotle** more relevant comparables than McDonald's and Wendy's.
    ...
    # Peer Comparison Chart - FIX APPLIED: Shortened Title and Increased margins
    ...
    fig_peers.update_layout(
        title="Peer Comparison (Total Locations)", # Shortened
        title_x=0.5,
        xaxis_tickangle=-30,
        yaxis=dict(
    ...
    fig_peers.add_annotation(
        ...
        xref="paper", yref="paper",
        x=0, y=-0.4, # FIX: Moved annotation down even further
        showarrow=False,
        font=dict(size=11, color="gray"),
        align="left"
    )
    fig_peers.update_layout(margin=dict(b=150)) # FIX: Increased bottom margin further
    ...
    with col1:
        # FIX APPLIED: Shortened title and fixed column display
        margin_data = {
            "company": [
                "Chipotle Mexican Grill",
                "Shake Shack",
...
# =============================================================================
    ...
    **Key Success Indicators:**
    ...
    # Revenue Growth vs Store Count - FIX APPLIED: Moved legend to top to prevent chart overlap
    ...
    for i, row in rev_data.iterrows():
        fig_rev.add_annotation(
            ...
            showarrow=False,
            yshift=5, # Reduced yshift slightly to be tighter to bar
