...
# =============================================================================
    ...
    with tab1:
        ...
        with col_controls_2:
             # Removed statsmodels dependency to prevent runtime errors
             pass
        ...
        fig_bubble = px.scatter(
            ...
            text="state_abbrev",
            trendline=None, # Explicitly removed to fix error
        ...
        st.caption("Size of bubble represents State Population.")
