...
Original file is located at
    https://colab.research.google.com/drive/1nN_Nz70MsJTIR0PGK8tsB2kTCq7df-1l
"""
...
# =============================================================================
    ...
    **Five Guys, BurgerFi, Smashburger, and Chipotle** more relevant comparables than McDonald's and Wendy's.
    ...
    fig_peers.update_yaxes(range=[0, df_peers["total_locations"].max() * 1.15])
    ...
    with col1:
        ...
        fig_margins = px.bar(
            ...
            title="Restaurant-Level Margins vs Premium Fast-Casual Peers",
